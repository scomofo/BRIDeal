...
class MaintainQuotesAPI:
    ...
    """
    def __init__(self, config: Config, jd_quote_api_client: Optional[JDQuoteApiClient] = None):
        """
        ...
        if not self.config:
            logger.error("MaintainQuotesAPI: Config object not provided. API will be non-functional.")
